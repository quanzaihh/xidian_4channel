...
localparam	WAIT_FOR_CMD 	= 3'd1;
localparam	OPEN			= 3'd2;
localparam	CHANGE_VOLTAGE	= 3'd3;
localparam	CHANGE_CURRENT  = 3'd4;
localparam	CHANGE_TEMP		= 3'd5;
localparam  CLOSE 			= 3'd6;
localparam  FINISH			= 3'd7;

reg [2:0]		control_state/* synthesis keep */;
