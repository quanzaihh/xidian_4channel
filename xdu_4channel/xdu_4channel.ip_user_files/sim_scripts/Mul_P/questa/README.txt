...
#
# Generated by export_simulation on Sun Apr 09 13:09:55 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './Mul_P.sh' script.
...
./Mul_P.sh -noclean_files

For more information on the script, please type './Mul_P.sh -help'.
