...
HD_PWD='C:/Users/Administrator/Desktop/xidian_4channel/xdu_4channel/xdu_4channel.runs/Mul_PID_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mul_PID.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mul_PID.tcl
