...
HD_PWD='C:/Users/Administrator/Desktop/xidian_4channel/xdu_4channel/xdu_4channel.runs/PID_adder_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PID_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PID_adder.tcl
