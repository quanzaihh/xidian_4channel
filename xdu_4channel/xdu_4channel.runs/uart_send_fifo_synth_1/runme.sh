...
HD_PWD='C:/Users/quanzai/Desktop/xidian_4channel/xdu_4channel/xdu_4channel.runs/uart_send_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_send_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_send_fifo.tcl
