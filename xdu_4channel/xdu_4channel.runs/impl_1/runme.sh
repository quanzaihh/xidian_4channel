...
HD_PWD='C:/Users/quanzai/Desktop/xidian_4channel-master/xidian_4channel-master/xdu_4channel/xdu_4channel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Multi_Channel_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Multi_Channel_top.tcl -notrace
