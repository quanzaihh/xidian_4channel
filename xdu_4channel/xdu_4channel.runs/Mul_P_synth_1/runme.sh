...
HD_PWD='C:/Users/quanzai/Desktop/xidian_4channel/xdu_4channel/xdu_4channel.runs/Mul_P_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mul_P.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mul_P.tcl
