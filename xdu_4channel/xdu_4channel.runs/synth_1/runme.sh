...
HD_PWD='C:/Users/quanzai/Desktop/xidian_4channel-master/xidian_4channel-master/xdu_4channel/xdu_4channel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multi_Channel_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multi_Channel_top.tcl
